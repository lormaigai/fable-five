# productivity-maxxing — Refactor & Quality Program
...
- **Avoid feature creep** — refactors must not add product surface. This is a *quality* program, not a feature program.
